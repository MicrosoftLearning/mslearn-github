...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/test-with-actions](https://github.com/skills-dev/test-with-actions)
...
1. When you finish all the challenges, you'll have a fully functional CI pipeline that automatically tests your code.

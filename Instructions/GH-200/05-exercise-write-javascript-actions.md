...
lab:
  ...
  description: Learn how to create custom GitHub Actions using JavaScript to extend
    automation capabilities and share reusable workflows.
  duration: 26 minutes
  level: 100
  islab: true
  primarytopics:
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/write-javascript-actions](https://github.com/skills-dev/write-javascript-actions)
...
1. When you finish all the challenges, you'll have created a functional custom action that you can use and share.

...
- Familiarity with the [Introduction to GitHub](https://github.com/skills-dev/introduction-to-github) course is recommended.
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/hello-github-actions](https://github.com/skills-dev/hello-github-actions)
...
1. When you finish all the challenges, you'll have created a functional GitHub Actions workflow that comments on pull requests.

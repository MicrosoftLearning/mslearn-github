...
lab:
  ...
  description: Learn how to publish and share your code packages using GitHub Packages,
    making your libraries available to others.
  duration: 26 minutes
  level: 200
  islab: true
  primarytopics:
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills/publish-packages](https://github.com/skills/publish-packages)
...
1. When you finish all the challenges, you'll understand how to publish and share packages using GitHub Packages.

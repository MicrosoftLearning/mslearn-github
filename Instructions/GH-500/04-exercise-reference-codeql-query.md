...
1. Start a web browser and navigate to the exercise repository: [https://github.com/githubtraining/exercise-reference-a-codeql-query](https://github.com/githubtraining/exercise-reference-a-codeql-query)

1. Follow the instructions provided in the repository's README to complete all the challenges.

1. Work through each step in the exercise, learning how to reference and use CodeQL queries.

   > **Note:** CodeQL can detect security vulnerabilities, bugs, and code quality issues across your codebase.

1. When you finish all the challenges, you'll understand how to leverage CodeQL for code security analysis.

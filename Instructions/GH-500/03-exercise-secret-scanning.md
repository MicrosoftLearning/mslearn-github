...
lab:
  ...
  description: Learn how to use GitHub's secret scanning to detect and prevent the
    exposure of sensitive credentials in your repositories.
  duration: 30 minutes
  level: 200
  islab: true
  primarytopics:
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/introduction-to-secret-scanning](https://github.com/skills-dev/introduction-to-secret-scanning)
...
1. When you finish all the challenges, you'll understand how to use secret scanning to protect your repositories.

...
1. Start a web browser and navigate to the exercise repository: [https://github.com/githubtraining/exercise-configure-codeql-language-matrix](https://github.com/githubtraining/exercise-configure-codeql-language-matrix)

1. Follow the instructions provided in the repository's README to complete all the challenges.

1. Work through each step in the exercise, configuring CodeQL to scan multiple languages.

   > **Note:** A language matrix enables parallel scanning of different languages, making the analysis more efficient.

1. When you finish all the challenges, you'll understand how to configure comprehensive multi-language code scanning.

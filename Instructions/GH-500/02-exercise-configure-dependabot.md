...
lab:
  ...
  description: Learn how to configure Dependabot to automatically update vulnerable
    dependencies and keep your repository secure.
  duration: 26 minutes
  level: 100
  islab: true
---
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/secure-repository-supply-chain](https://github.com/skills-dev/secure-repository-supply-chain)
...
1. When you finish all the challenges, you'll understand how to maintain secure dependencies using Dependabot.

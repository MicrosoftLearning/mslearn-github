...
lab:
  ...
  description: Learn how to connect work items, link issues and pull requests, and
    organize your work effectively in a GitHub repository.
  duration: 30 minutes
  level: 100
  islab: true
  primarytopics:
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills/connect-the-dots](https://github.com/skills/connect-the-dots)
...
1. When you finish all the challenges, you'll understand how to organize and connect work in GitHub repositories.

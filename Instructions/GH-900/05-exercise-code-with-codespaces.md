...
lab:
  ...
  description: Use GitHub Codespaces and Visual Studio Code to develop and run code
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/code-with-codespaces](https://github.com/skills-dev/code-with-codespaces)
...
1. When you finish all the challenges, you'll understand how to use Codespaces for your development workflow.

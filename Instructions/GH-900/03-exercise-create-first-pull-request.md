...
lab:
  ...
  description: Learn how to make your first contribution to open source. Follow step-by-step
    instructions to fork, clone, branch, commit, and create a pull request.
  duration: 30 minutes
  level: 100
  islab: true
---
...
- Git installed on your local machine. If you don't have git installed, refer to [Set up Git](https://docs.github.com/en/get-started/quickstart/set-up-git).
...
1. Start a web browser and navigate to the exercise repository: [https://github.com/firstcontributions/first-contributions](https://github.com/firstcontributions/first-contributions)

1. Follow the detailed instructions in the README, which will guide you through:
...
1. Work through each step carefully, following the instructions and screenshots provided in the repository.
...
1. Once you submit your pull request, it will be reviewed and merged by the project maintainers.

1. After your pull request is merged, you'll receive a notification email, and you can celebrate your first contribution!

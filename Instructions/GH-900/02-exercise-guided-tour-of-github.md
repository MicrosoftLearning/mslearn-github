...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/introduction-to-github](https://github.com/skills-dev/introduction-to-github)
...
1. Follow the instructions on the repository's README to complete all the challenges.
...
1. Work through each step in the exercise, following the prompts and instructions provided in the README and in the issues/pull requests that the exercise creates for you.

1. When you finish all the challenges, you will have created a short Markdown file you can use as your profile README.

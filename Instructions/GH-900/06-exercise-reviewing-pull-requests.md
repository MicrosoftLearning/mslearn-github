...
1. Start a web browser and navigate to the exercise repository: [https://github.com/skills-dev/review-pull-requests](https://github.com/skills-dev/review-pull-requests)
...
1. Work through each step in the exercise, following the prompts and instructions provided in the pull requests.
...
1. When you finish all the challenges, you'll be comfortable with the pull request review process.

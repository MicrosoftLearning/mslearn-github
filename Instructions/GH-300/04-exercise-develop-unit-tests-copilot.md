...
lab:
  ...
  description: Learn how to use GitHub Copilot to generate comprehensive unit tests
    and improve code quality through AI-assisted testing.
  duration: 24 minutes
  level: 100
  islab: true
  primarytopics:
...
1. Work through each step, using GitHub Copilot to generate comprehensive unit tests.

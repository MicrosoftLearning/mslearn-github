...
lab:
  ...
  description: Learn how to use GitHub Copilot to update and enhance a Python web
    API efficiently.
  duration: 24 minutes
  level: 200
  islab: true
...
1. Work through each step, using GitHub Copilot to update and enhance the Python web API.

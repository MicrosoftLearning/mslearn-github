...
lab:
  ...
  description: Learn how to use use GitHub Copilot CLI as a standalone terminal tool
    to manage issues and build a Node.js calculator app
  duration: 22 minutes
  level: 100
  islab: true
  primarytopics:
...
1. Open a web browser and navigate to the exercise page:  
   [https://github.com/skills/create-applications-with-the-copilot-cli](https://github.com/skills/create-applications-with-the-copilot-cli)

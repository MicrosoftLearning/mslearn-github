...
Welcome! This repository contains all the instructions and resources needed to complete hands-on exercises from the **GitHub learning paths** on [Microsoft Learn](https://learn.microsoft.com/).

Whether you're exploring GitHub fundamentals or diving deeper into advanced collaboration and automation practices, this repo is your companion for guided, practical learning.
